...
const skillData = {
    ...
    'Ataque de Explosão': {
        ...
        levels: [
            'Acúmulo de Explosão +5%. Bônus: +10.',
            'Acúmulo de Explosão +10%. Bônus: +10.',
            'Acúmulo de Explosão +20%. Bônus: +10.',
            'Acúmulo de Explosão +30%. Bônus: +10.',
        ]
    },
    'Maestro de Sonoro': {
        desc: 'Aumenta o tempo do efeito de melodias do berrante de caça.',
        levels: [
            'Prolonga a duração do efeito de melodia e aumenta a regeneração de vida.',
            'Aumenta bastante o tempo do efeito de melodias do berrante de caça.',
        ]
    },
    'Surto de Vigor': {
        desc: 'Acelera a regeneração de vigor.',
        levels: [
            'Velocidade de regeneração de vigor +10%.',
            'Velocidade de regeneração de vigor +20%.',
            'Velocidade de regeneração de vigor +30%.',
        ]
    },
    'Bainha Rápida': {
        desc: 'Acelera o embainhamento da arma.',
        levels: [
            'Aumenta um pouco a velocidade de embainhamento.',
            'Aumenta razoavelmente a velocidade de embainhamento.',
            'Aumenta bastante a velocidade de embainhamento.',
        ]
    },
    'Comer Rapidamente': {
        desc: 'Aumenta a velocidade de ingestão de carne e consumo de itens.',
        levels: [
            'Aumenta um pouco a velocidade de uso de itens.',
            'Aumenta razoavelmente a velocidade de uso de itens.',
            'Aumenta bastante a velocidade de uso de itens.',
        ]
    },
    'Afiação Rápida': {
        desc: 'Acelera a afiação da arma ao usar uma pedra de amolar.',
        levels: [
            'Remove um ciclo do processo de afiação.',
            'Remove dois ciclos do processo de afiação.',
            'Remove três ciclos do processo de afiação.',
        ]
    },
    'Bênção Divina': {
        desc: 'Há uma chance predeterminada de reduzir o dano recebido.',
        levels: [
            'Ativado, reduz o dano recebido em 15%.',
            'Ativado, reduz o dano recebido em 30%.',
            'Ativado, reduz o dano recebido em 50%.',
        ]
    },
    'Sem Recuo': {
        desc: 'Evita empurrões e outras reações a danos pequenos.',
        levels: [
            'Evita empurrões. Aumenta alguns efeitos de extrato de Kinseto.',
            'Evita empurrões. Queda reduzida a empurrão. Aumenta alguns efeitos de extrato de Kinseto.',
            'Evita empurrões e quedas. Aumenta alguns efeitos de extrato de Kinseto.',
        ]
    },
